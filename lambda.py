...
def setGlobalVars(event):
    ...
    try:
        globalVars['Owner'] = event.get('Owner', "ab")
        globalVars['Environment'] = event.get('Environment', "Test")
        globalVars['REGION_NAME'] = event.get('REGION_NAME', "ap-south-1")
        globalVars['tagName'] = event.get('tagName', "womp-bot")
        ...
        globalVars['RetentionDays'] = event.get('RetentionDays', "1")
